...
`/reset` will reset the data in the database with a load of:awefawfe
 - userswefawefafwe
 - jokesaewf
 - hecklesawefawefawefawfeawfefawe
  awef
`/feed` shows the jokes/heckles that are rawefelevant to the current user.awef
